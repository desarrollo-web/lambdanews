...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('news_submission', 'author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submissions', null=True, to=orm['auth.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Submission.author'
        db.delete_column('news_submission', 'author_id')
    ...
    models = {
        ...
        'news.submission': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'submissions'", 'null': 'True', 'to': "orm['auth.User']"}),
